...
complete -c forge -n "__fish_seen_subcommand_from test" -l optimize-runs -d 'The number of optimizer runs.' -r
...
complete -c forge -n "__fish_seen_subcommand_from build" -l optimize-runs -d 'The number of optimizer runs.' -r
...
complete -c forge -n "__fish_seen_subcommand_from run" -l optimize-runs -d 'The number of optimizer runs.' -r
...
complete -c forge -n "__fish_seen_subcommand_from create" -l optimize-runs -d 'The number of optimizer runs.' -r
...
complete -c forge -n "__fish_seen_subcommand_from snapshot" -l optimize-runs -d 'The number of optimizer runs.' -r
...
complete -c forge -n "__fish_seen_subcommand_from config" -l optimize-runs -d 'The number of optimizer runs.' -r
...
complete -c forge -n "__fish_seen_subcommand_from inspect" -l optimize-runs -d 'The number of optimizer runs.' -r
